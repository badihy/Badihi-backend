...
export async function seedCourseCatalog(
  ...
  const jsLesson2 = await lessonModel.create({
    ...
    description: 'Learn how to define and call functions and how scope works.',
    orderIndex: 2,
    chapter: jsChapter1._id,
  ...
  const jsChapter2 = await chapterModel.create({
    ...
    description: 'A short quiz covering variables, data types, and functions.',
    orderIndex: 2,
    course: jsCourse._id,
  });
  ...
  const reactChapter2 = await chapterModel.create({
    ...
    subtitle: 'Check your understanding before moving to advanced topics',
  ...
  return {
    ...
    courses: {
      ...
      reactFundamentals: {
        course: reactCourse,
        lessons: [reactLesson1, reactLesson2],
        quizzes: [reactQuiz],
      },
    },
  };
